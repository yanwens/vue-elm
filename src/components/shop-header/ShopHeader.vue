<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click="isShowMsg = true">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="isShowSupports = true">
      <div class="discounts-left">
        <div class="activity "  :class="classArr[info.supports[0].type]">
          <span class="content-tag">
    ...
    <transition name="show">
      <div class="shop-brief-modal" v-if="isShowMsg">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer" @click="isShowMsg = false">
      ...
      <div class="activity-sheet" v-if="isShowSupports">
        <div class="activity-sheet-content">
          <h2 class="activity-sheet-title">
            优惠活动</h2>
          <ul class="list">
            <li class="activity-item" v-for="(support, index) in info.supports" :key="index" :class="classArr[support.type]">
            <span class="content-tag">
